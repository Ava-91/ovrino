...
export function AudioPlayerCard({ text, voiceName, playing, onPlayPause, onStop }: AudioPlayerCardProps) {
  ...
  return <View style={styles.card}>
    ...
    <View style={styles.controls}><Pressable accessibilityLabel="Back 10 seconds" onPress={() => seek(-10)} style={styles.smallButton}><Text style={styles.smallText}>−10</Text></Pressable><Pressable accessibilityLabel={playing ? 'Pause audio' : 'Play audio'} onPress={onPlayPause} style={styles.playButton}><Text style={styles.playText}>{playing ? 'Ⅱ' : '▶'}</Text></Pressable><Pressable accessibilityLabel="Forward 10 seconds" onPress={() => seek(10)} style={styles.smallButton}><Text style={styles.smallText}>+10</Text></Pressable></View>
